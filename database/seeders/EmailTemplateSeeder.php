    ...
    public function run()
    {
        $emailTemplates = [
            ...
            [
                ...
                'body_content'       => 'You have been invited to the Lab Program component_title by user_name. Use the link below to register and log in on PreprLabs with this email address. You will be added to the Project once you log in.',
                'fr_CA_body_content' => 'Vous avez été invité au programme Lab composant_titre par nom_utilisateur. Utilisez le lien ci-dessous pour vous inscrire et vous connecter à PreprLabs avec cette adresse e-mail. Vous serez ajouté au projet une fois connecté.',
            ],
        ];
