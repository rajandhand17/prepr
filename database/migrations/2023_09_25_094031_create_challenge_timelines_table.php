...
return new class() extends Migration {
    ...
    public function up(): void
    {
        Schema::create('challenge_timelines', function (Blueprint $table) {
            ...
            $table->timestamp('last_call_date')->nullable()->comment('Date of restricted challenge,ending to start challenge');
            $table->longText('last_call_date_description')->nullable();
            $table->timestamp('application_deadline_date')->nullable()->comment('Date of restricted challenge,ending to start challenge');
            $table->longText('application_deadline_date_description')->nullable();
            $table->timestamp('submission_deadline_date')->nullable()->comment('Date of restricted challenge,submit challenge');
