...
return new class() extends Migration {
    ...
    {
        Schema::create('resource_groups_social_activities', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('resource_group_id')->references('id')->on('resource_groups')->onDelete('cascade')->name('rgsa_resource_collection_id_foreign');
    ...
    {
        Schema::dropIfExists('resource_groups_social_activities');
    }
};
