        ...
        try {
            ...
            DB::connection('mysql2')->table('users')->chunkById(1000, function ($users) {
                foreach ($users as $key => $single_user) {
                    ...
                    $user->display_lab_minionboarding=$single_user->display_lab_mini_onboarding;
                    $user->display_challenge_minionboarding=$single_user->display_challenge_mini_onboarding;
                    $user->display_org_minionboarding=$single_user->display_organization_mini_onboarding;
