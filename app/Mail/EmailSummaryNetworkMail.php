...
class EmailSummaryNetworkMail extends Mailable
{
    use Queueable;
    ...
    {
        return $this->subject($this->summeryContent['subjectnetwork'])->view('email.email-summary.email-summary-network-mail');
    }
}
