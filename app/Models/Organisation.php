    ...
    public function checkorgnization($request)
    {
        try {
            ...
            if($checkorganization){
                return response()->json(['status'=>"fail","message"=>"This organization is already registered!"]);
            }
             return response()->json(["status"=>"success","message"=>"This organization is not registered with us!"]);
        } catch (\Exception $e){
