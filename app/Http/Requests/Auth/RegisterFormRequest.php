...
class RegisterFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'user_type'              => 'required|in:learner,job_seeker,employee,educator,employer,mentor',
            'purpose'                => 'required|in:looking_employers,looking_team,looking_employees,looking_to_solve_problems,educator,mentor',
