...
class RegisterFormRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'first_name.required'            => __('responses.required_field'),
            'first_name.max'                 => __('responses.max_content_20'),
            'first_name.string'              => __('responses.string_data_allowed'),
            'last_name.required'             => __('responses.required_field'),
            ...
            'user_type.required'             => __('responses.required_field'),
            ...
            'register_type.required'         => __('responses.required_field'),
