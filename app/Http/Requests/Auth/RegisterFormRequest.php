...
class RegisterFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'user_type'              => 'required_if:register_type,==,user|in:learner,job_seeker,employee,educator,employer,mentor',
            'user_type'              => 'required_if:register_type,==,organization|in:enterprise,small,startup,community,ngo,government,educational,others',
