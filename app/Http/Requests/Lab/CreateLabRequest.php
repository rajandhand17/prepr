...
class CreateLabRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'privacy.in'                =>__('notification.notification_privacy'),
            'privacy.required'          =>__('notification.notification_privacy'),
            'latitude.required'          =>__('responses.latitude_required'),
            'longitude.required'          =>__('responses.longitude_required'),
            ...
            'country.required'      => __('notification.notification_tcfir'),
            'city.required'      => __('notification.notification_cirrrr'),
            ...
            'category_id.exists'        => __('notification.notification_cat'),
            'skills.required'           => __('notification.notification_skillmbs'),
            'skills.exists'             => __('notification.notification_skillmbs'),
            'tags.required'              => __('responses.tags'),
            ...
            'achievement_conditions.required'=> __('responses.achievement_condition'),
            'achievement_conditions.array' => __('responses.achievement_condition_array'),
            'challenge_id.required'      => __('responses.challenge_id'),
            'challenge_path_id.required' => __('responses.challenge_path'),
            'skill_groups.*.exists' => __('responses.skill_groups_exists'),
            'skill_groups.*.array' => __('responses.skill_groups_array'),
            'skill_stacks.*.array' => __('responses.skill_stacks_array'),
            'skill_stacks.*.exists' => __('responses.skill_stacks_exists'),
            'tag_groups.*.exists' => __('responses.tag_groups_exists'),
            'tag_groups.*.array' => __('responses.tag_groups_array'),
            'tag_groups.*.numeric' => __('responses.tag_groups_numeric'),
            'is_notification_enabled.in' => __('responses.tag_groups_numeric'),
            'is_achievement_enabled.in' => __('responses.is_achievement_enabled'),
            'is_sequential.in' => __('responses.is_achievement_enabled'),
            'is_resource_sequential.in' => __('responses.is_resource_sequential'),
            'external_links.array' => __('responses.external_links_array'),
            'external_links.url' => __('responses.external_links_url'),
            'external_link_ids.exists' => __('responses.external_links_ids_exists'),
            'external_link_ids.array' => __('responses.external_links_ids_array'),
            'external_link_ids.numeric' => __('responses.external_links_ids_numeric'),
            'lab_programs.*.numeric'=>__('responses.lab_programs_numeric'),
            'lab_programs.*.array'=>__('responses.lab_programs_numeric'),
            ...
            'resource_groups.*.numeric'=>__('responses.resource_modules_numeric'),
            'resource_groups.*.array'=>__('responses.resource_modules_array'),
            ...
            'auto_invite.in'=>__('responses.auto_invite_in'),
            'invite_email.required'=>__('responses.invite_email_required'),
            'invite_email.csv'=>__('responses.invitee_email_csv'),
            'invite_email.*.required'=>__('responses.invite_emails'),
        ];
    }
}
