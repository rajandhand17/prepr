...
class UpdateLabDashboardLayoutRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        $base_rules = [
            ...
            'card_type.*'      => 'required|in:reports,deadlines,leaderboard,my-challenges,my-labs,my-projects,my-resources,inbox-friends,recommendations,subscription',
