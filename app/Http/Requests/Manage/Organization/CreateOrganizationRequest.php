...
class CreateOrganizationRequest extends FormRequest
{
    ...
    {
        return[
            'title.required'                                 => __('responses.api_title_required'),
            'title.max'                                      => __('responses.max_content_255'),
            'title.unique'                                   => __('responses.already_exists'),
            'description.required'                           => __('responses.api_description_required'),
            ...
            'organization_address.*.address_1.required'      => __('responses.api_organization_address_required'),
            'organization_address.*.address_1.string'        => __('responses.string_data_allowed'),
            'organization_address.*.address_2.required'      => __('responses.api_organization_address_required'),
            'organization_address.*.address_2.string'        => __('responses.string_data_allowed'),
            'organization_address.*.city.required'           => __('responses.api_city_required'),
            'organization_address.*.city.string'             => __('responses.string_data_allowed'),
            'organization_address.*.state.required'          => __('responses.api_state_required'),
            'organization_address.*.state.string'            => __('responses.string_data_allowed'),
            'organization_address.*.country.required'        => __('responses.api_country_required'),
            'organization_address.*.country.string'          => __('responses.string_data_allowed'),
            'organization_address.*.zip_code.required'       => __('responses.api_zip_code_required'),
            'organization_address.*.zip_code.string'         => __('responses.string_data_allowed'),
            'organization_address.*.latitude.required'       => __('responses.api_latitude_required'),
            'organization_address.*.latitude.string'         => __('responses.string_data_allowed'),
            'organization_address.*.longitude.required'      => __('responses.api_longitude_required'),
            'organization_address.*.longitude.string'        => __('responses.string_data_allowed'),
            'organization_members.array'                     => __('responses.array'),
            'organization_members.*.name.required'           => __('responses.api_name_required'),
            'organization_members.*.name.string'             => __('responses.string_data_allowed'),
            'organization_members.*.position.required'       => __('responses.api_position_required'),
