    ...
    public function toArray(Request $request): array
    {
        ...
        if ($this->resource_collection) {
            foreach ($this->resource_collection as $resource_collection) {
                ...
                $resourceCollection[$resource_collection->resource_collection]['slug'] = ResourceCollectionService::getResourceCollectionBasedOnId($resource_collection->resource_collection_id)->slug;
            }
        }
