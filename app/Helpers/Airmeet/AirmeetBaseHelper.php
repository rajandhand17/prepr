...
class AirmeetBaseHelper
{
     ...
     */
    static public function get(string $url, array $params = [], array $headers = [], int $iteration = 1, bool $fresh = false): false|PromiseInterface|Response
    {
        try {
     ...
     * @return false|PromiseInterface|Response
     */
    static public function post(string $url, array $data, array $headers = [], int $iteration = 1, bool $fresh = false): false|PromiseInterface|Response
    {
        try {
     ...
     * @return array
     */
    static public function getAirMeetHeader(bool $fresh = false): array
    {
    ...
    static public function getAirMeetToken()
    {
        $response = Http::baseUrl(config('airmeet.airmeet_base_url'))->withHeaders([
     ...
     * @return bool
     */
    static public function isValidToken(AirmeetAuthToken $airmeetAuthToken): bool
    {
