...
<body>
    <div class="content-container">
        ...
        <div class="message">
		Dear {{ ucfirst($data['first_name']); }} {{ ucfirst($data['last_name']); }}<br><br>
		We’ve received a request for registeration, Please verify your account. if you have not requested for registeration, than ignore the message.
            <br><br>
            Regards,
            <br>
            Prepr team
