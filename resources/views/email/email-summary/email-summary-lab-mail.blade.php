            ...
            <tr>
              <td style="padding:20px 30px 10px; ">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                      <td align="center">
                          <div style="padding-top: 5px;font-size: 20px;color:#101223;"> {{ $summeryContent['emlauy'] }} <br> {{ $summeryContent['proov'] }} </div><br>
                      </td>
                  </tr>
                </table>
              </td>
            ...
            <td style="padding:0px 30px 10px; ">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <hr style="color:#D2D4DA;height: 1px;background-color: #D2D4DA;" align="center" width = "40%">
                        <div style="padding-top: 5px;font-size: 23px;color:#13A859;">{{ $summeryContent['ttlyiw'] }}  </div><br>
                        <div style="padding-top: 5px;font-size: 23px;color:#13A859;">{{ $summeryContent['most'] }} </div><br>
                    </td>
                </tr>
              </table>
            </td>
                  ...
                  <tr>
                    <td style="padding:20px 30px 10px; ">
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center">
                                <div style="padding-top: 5px;font-size: 20px;color:#101223;"> {{ $summeryContent['emlacydd'] }} <br> {{ $summeryContent['lejn'] }} </div><br>
                            </td>
                        </tr>
                      </table>
                    </td>
