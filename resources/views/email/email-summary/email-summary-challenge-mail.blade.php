            ...
            <tr>
              <td style="padding:20px 30px 10px; ">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                      <td align="center">
                        <a href="{{ route('Explore') }}"><button type="button" class="button btn-success" style="border: none; margin-top: 10px;padding: 10px 10px 10px 10px;color: white;background-color: #13A859;border-radius: 6px;font-size: initial;"> {{ $summeryContent['explorechallenge'] }} </button> </a>
                      </td>
                  </tr>
                </table>
              </td>
            ...
            <td style="padding:20px 30px 10px; ">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td align="center">
                        <hr style="color:#D2D4DA;height: 1px;background-color: #D2D4DA;" align="center" width = "40%">
                        <div style="padding-top: 12px;font-size: 23px;"><img src="{{ CDN::asset('front/img/achievement.png')}}" style="height: 19px;"> {{ $summeryContent['ttcamt'] }} </div><br>
                    </td>
                </tr>
              </table>
            </td>
            ...
            <td style="padding:20px 30px 10px; ">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr style="font-size: 14px;">
                    ...
                    <p>{{ $summeryContent['tewst'] }} <span style="color:#0D8D55; text-decoration: underline;">{{ $user->email }}</span> {{ $summeryContent['byorc'] }}  <a href="{{ url()->shorten(route('unsubscribeSummary',['challenge',$user->id])) }}"> <span style="color:#0D8D55; text-decoration: underline;">{{ $summeryContent['unsubscribe'] }}</span></a></p>
                    </td>
                </tr>
              </table>
            </td>
