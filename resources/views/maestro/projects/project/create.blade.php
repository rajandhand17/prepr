        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group {{($errors->has('challenge_id')) ? 'has-error' : ''}}">
              ...
              {{ Form::select('challenge_id', [], old('challenge_id'), ['class' => 'form-control select2bs4','id' => 'associativeChallenge','required' => 'required']) }}
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('lab_id')) ? 'has-error' : ''}}">
              ...
              {{ Form::select('lab_id', [], old('lab_id'), ['class' => 'form-control select2bs4','id' => 'associativeLab']) }}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group {{($errors->has('stage')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('stage', $projectData['project_stage'] ?? [], old('stage'), ['class' => 'form-control','required' => 'required']) !!}
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('type')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('type', $projectData['project_type'] ?? [], old('type'), ['class' => 'form-control','required' => 'required']) !!}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group {{($errors->has('status')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('status', $projectData['project_status'] ?? [], old('status'), ['class' => 'form-control','required' => 'required']) !!}
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('industry')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('industry', $projectData['project_industry'] ?? [], old('industry'), ['class' => 'form-control','required' => 'required']) !!}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group {{($errors->has('verticals')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('verticals', $projectData['project_verticals'] ?? [], old('verticals'), ['class' => 'form-control','required' => 'required']) !!}
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('category')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('category', $projectData['project_category'] ?? [], old('category'), ['class' => 'form-control','required' => 'required']) !!}
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group {{($errors->has('team')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('team[]',[],old('team'), ['class' => 'form-control select2bs4', 'id'=>'teamMemberId','required' => 'required','multiple'=>'multiple']) !!}
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('privacy')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('privacy', $projectData['project_privacy'] ?? [], old('privacy'), ['class' => 'form-control','required' => 'required']) !!}
