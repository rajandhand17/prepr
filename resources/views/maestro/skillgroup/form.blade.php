...
<div class="row form-group ">
    ...
    <div class="col-md-6 col-xs-12">
        <div class="form-group {{($errors->has('group_skills')) ? 'has-error' : ''}}">
            ...
            {!! Form::select('group_skills[]', $skills, $selectedSkills, ['class' => 'form-control select2', 'multiple'=> 'multiple','id' => 'group-skills']) !!}
    ...
    <div class="col-md-6 col-xs-12">
        <div class="form-group {{($errors->has('group_stacks')) ? 'has-error' : ''}}">
            ...
            {!! Form::select('group_stacks[]', $stacks, $selectedStacks, ['class' => 'form-control select2', 'multiple'=> 'multiple','id' => 'group-stacks']) !!}
