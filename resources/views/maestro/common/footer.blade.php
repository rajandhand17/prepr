...
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js'}}"></script>
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/inputmask/jquery.inputmask.min.js'}}"></script>
<!-- bootstrap color picker -->
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js'}}"></script>
<!-- Bootstrap Switch -->
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/bootstrap-switch/js/bootstrap-switch.min.js'}}"></script>
<!-- BS-Stepper -->
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/bs-stepper/js/bs-stepper.min.js'}}"></script>
<!-- dropzonejs -->
<script src="{{config('site-settings.maestro_cdn_url').'public/maestro/plugins/dropzone/min/dropzone.min.js'}}"></script>
