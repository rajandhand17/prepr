        ...
        <div class="row">
          <div class="col-md-3">
            <div class="form-group {{($errors->has('privacy')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('privacy', ['0' => 'Public', '1' => 'Private'], $resourceModule->privacy, ['class' => 'form-control']) !!}
          ...
          <div class="col-md-3">
            <div class="form-group {{($errors->has('is_global')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('is_global', ['1' => 'Yes', '0' => 'No'], $resourceModule->is_global, ['class' => 'form-control']) !!}
