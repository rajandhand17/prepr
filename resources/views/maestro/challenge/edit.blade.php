      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('organization_id')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('organization_id', [], $challenge->organization_id, ['class' => 'form-control select2bs4','required' => 'required','id' =>'organisationId','required' => 'required']) }}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('category_id')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('category', [], $challenge->category_id, ['class' => 'form-control select2bs4','id' => 'listCategory','required' => 'required']) }}
        ...
        <div class="col-md-6">
          <div class="form-group {{($errors->has('skills')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('skills[]', [], old('skills'), ['class' => 'form-control select2bs4','id' => 'challengeSkills','required' => 'required' ,'multiple' => 'multiple']) }}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('level')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('level', [], $challenge->level_id, ['class' => 'form-control select2bs4','id' => 'challengeLevels','required' => 'required']) }}
        ...
        <div class="col-md-6">
          <div class="form-group {{($errors->has('duration')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('duration', [], $challenge->duration_id, ['class' => 'form-control select2bs4','id' => 'challengeDuration','required' => 'required']) }}
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('user_id')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('user_id',[],$challenge->user_id, ['class' => 'form-control select2bs4', 'id'=>'userId','required' => 'required']) !!}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('associativeLab')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('associativeLab[]', [], old('associativeLab'), ['class' => 'form-control select2bs4','id' => 'associativeLab','required' => 'required','multiple' => 'multiple']) }}
        ...
        <div class="col-md-6">
          <div class="form-group {{($errors->has('associativeResourceModule')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('associativeResourceModule[]', [], old('associativeResourceModule'), ['class' => 'form-control select2bs4','id' => 'resourceModule','required' => 'required','multiple' => 'multiple']) }}
