...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card card-default">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group {{($errors->has('language')) ? 'has-error' : ''}}">
              ...
              {!! Form::select('language', $languages, $challenge->Language, ['class' => 'form-control','id' => 'languageId','required' => 'required']) !!}  
      ...
      <div class="row">
        <div class="col-md-6">
          <p>{{ $challenge->organization_id }}</p>
          <div class="form-group {{($errors->has('organization_id')) ? 'has-error' : ''}}">
            {!! Form::label('organization_id', 'Organization', ['class' => 'control-label']) !!}
            {{ Form::select('organization_id', ['prepr'], $challenge->organization_id, ['class' => 'form-control select2bs4','required' => 'required','id' =>'organisationId','required' => 'required']) }}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('category')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('category', [], $challenge->category, ['class' => 'form-control select2bs4','id' => 'listCategory','required' => 'required']) }}
        ...
        <div class="col-md-6">
          <div class="form-group {{($errors->has('skills')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('skills', [], $challenge->skills, ['class' => 'form-control select2bs4','id' => 'challengeSkills','required' => 'required']) }}
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group {{($errors->has('level')) ? 'has-error' : ''}}">
            ...
            {{ Form::select('level', [], $challenge->level, ['class' => 'form-control select2bs4','id' => 'challengeLevels','required' => 'required']) }}
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group {{($errors->has('agreement')) ? 'has-error' : ''}}">
              ...
              {!! Form::textarea('agreement',$challenge->agreement, ['class' => 'form-control', 'rows'=>'10',"id"=>"agreement"]) !!}
