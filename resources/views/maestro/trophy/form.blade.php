...
<div class="col-md-6">
    ...
    <input type="text" class="form-control datetimepicker-input" data-target="#issue_trophy_date" name="issue_trophy_date" value="@isset($awardedTrophies){{$awardedTrophies->issue_trophy_date}}@endif" />
    ...
    <input type="text" class="form-control datetimepicker-input" data-target="#expiration_date" name="expiration_date" value="@isset($awardedTrophies){{$awardedTrophies->expiration_date}}@endif" />
    ...
    <div class=" form-group {{($errors->has('trophy_code_id')) ? 'has-error' : ''}}">
        ...
        {!! Form::text('trophy_code_id',null,['class' => 'form-control']) !!}
    ...
    <div class=" form-group {{($errors->has('no_of_times_issued')) ? 'has-error' : ''}}">
        ...
        {!! Form::selectRange('no_of_times_issued', 1, 20 , null , ['class' => 'form-control']) !!}
...
<div class="col-md-6">
    <div class="form-group {{($errors->has('description')) ? 'has-error' : ''}}">
        ...
        {!! Form::textarea('description',null, ['class' => 'form-control','rows'=>'12','style'=>'resize:none;']) !!}
        ...
        <div class="row">
                ...
                <div class=" form-group {{($errors->has('image')) ? 'has-error' : ''}}">
                    ...
                    @if(isset($awardedTrophies->image) && $awardedTrophies->image !== '')
                        <div class="pull-right">
                            <img src="{{asset($awardedTrophies->image)}}" onerror="this.onerror=null;this.src='{{config(('site-settings.maestro_cdn_url').'public/front/img/no-img.jpg')}}';" width="auto" height="50px">
                        </div>
                    @endif
            ...
            <div class="col-md-6">
                <div class=" form-group {{($errors->has('user_id')) ? 'has-error' : ''}}">
                    ...
                    {!! Form::select('user_id[]', $users , $awardedMembers , ['class' => 'form-control select2', 'multiple'=> 'multiple','id' => 'users']) !!}
    ...
    <div class="form-group">
        <div class=" form-group {{($errors->has('points_gained')) ? 'has-error' : ''}}">
            ...
            {!! Form::number('points_gained',null, ['class' => 'form-control']) !!}
