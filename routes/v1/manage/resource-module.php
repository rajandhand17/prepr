...
Route::middleware(['language', 'auth:api'])->group(function () {
    ...
    Route::post('/ai/challenge/create/preview', [ResourceModuleController::class, 'CreateResourceModuleUsingAIPreview'])->middleware('permission:create_resource_module');
    Route::post('/ai/challenge/create', [ResourceModuleController::class, 'CreateResourceModuleUsingAI'])->middleware('permission:create_resource_module');
});
