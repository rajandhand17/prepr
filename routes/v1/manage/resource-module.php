...
Route::middleware(['language', 'auth:api'])->group(function () {
    ...
    Route::post('/ai/create-from-challenge-preview', [ResourceModuleController::class, 'CreateResourceModuleUsingAIPreview'])->middleware('permission:create_resource_module');
    Route::post('/ai/create-from-challenge', [ResourceModuleController::class, 'CreateResourceModuleUsingAI'])->middleware('permission:create_resource_module');
});
